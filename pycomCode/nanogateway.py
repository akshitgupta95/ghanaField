...
class NanoGateway:
    ...
    def start(self):
        ...
        self._log(
            "Setting up the LoRa radio at {} Mhz using {}",
        ...
        self.lora.callback(
            trigger=(LoRa.RX_PACKET_EVENT | LoRa.TX_PACKET_EVENT), handler=self._lora_cb
        )
    ...
    def _log(self, message, *args):
        ...
        print(
            "[{:>10.3f}] {}".format(utime.ticks_ms() / 1000, str(message).format(*args))
        )
